...
namespace System
{
    public class ToHtmlOptions
    {
        ...
        public bool OrderByPropNames = false;
    }
    ...
    public static class HtmlValue
    {
        ...
        public static String OfList<T>(IEnumerable<T> en, ToHtmlOptions? options = null)
        {
            ...
            try
            {
                ...
                buf.Append(OfDataTable(dt, options));
            }
            catch (Exception ex)
            {
        ...
        {
            return DataTableX.ToHtml(dt, false, true);
        }
        ...
        public static String Of(NameValueCollection nvs, ToHtmlOptions? options = null)
        {
            ...
            //var buf = new Html32TextWriter(sw);
            //hw.WriteLine("....");
            //if (captionTitle != null)
            //{
            //    buf.WriteLine("<p>");
            //    buf.WriteLine(captionTitle + ":");
            //    buf.WriteLine("</p>");
            //}
            ...
            if (options.Caption != null)
            {
                buf.Write("<h3>"); // caption>");
                buf.Write(options.Caption);
                buf.WriteLine("</h3>"); // caption>");
            }
            ...
            else
            {
                ...
                foreach (String k in nvs.Keys) //Keys: NameObjectCollectionBase.KeysCollection
                {
                    ...
                    //string v = (nvs[k] ?? (object)"null").ToString(); //.ToString();//Not need cast for NVCol
                    //v += "zz";
