...
public abstract class MyDbConnection : DbConnectionString, IDisposable
{
    ...
    public DateTime GetServerDateTime()
    {
        using (var cmd = dbc.CreateCommand())
        {
            ...
            logger.LogInformation("SQL Server datetime is: " + ret);
            return (DateTime)ret;
        }
    }
    ...
    public DbConnection GetDbConnection()
    {
        if (_dbc == null)
        {
            ...
            logger.LogInformation("++DB opened: " + GetConnectionInfo());
        ...
        if (!disposed)
        {
            if (disposing)
            {
                ...
                if (_dbc != null)
                {
                    ...
                    {
                        _dbc.Dispose();
                        logger.LogInformation("--Database connection disposed");
                    }
                    catch (Exception ex)
                    {
    ...
    public void RollbackTransaction(Exception ex = null)
    {
        if (Transaction != null)
        {
            ...
            logger.LogInformation(ex, "Transaction Rollbacked");
            Transaction = null;
        }
        //try
        //{
    ...
    {
        logger.LogInformation(ex, "Rollback because exception");
        try
        {
            tx.Rollback();
        }
    ...
    //===================================================================================================
    public static QueryOptions CheckOptions(QueryOptions? options)
    {
    ...
    //===================================================================================================
    public DbCommand CreateCommand(QueryOptions? options)
    {
    ...
    public void SetParameters(IDbCommand cmd, object cmdParams)
    {
        ...
        foreach (var paramName in paramNames)
        {
            ...
            if (prop == null)
            {
                logger.LogInformation(HtmlValue.OfAny(props.Keys, new() { Caption = "DbCommand Parameter Keys" }));
