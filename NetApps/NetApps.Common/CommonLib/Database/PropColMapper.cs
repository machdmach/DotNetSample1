...
public class PropColMapper
{
    ...
    public void AddPropColMapping(String propName, string colName)
    {
        ...
        logger.LogInformation("propName mapped: " + propName);
    ...
    public void AddPropColMappings(Dictionary<string, string> addlPropColNamePairs)
    {
        ...
        {
            logger.LogInformation("addlPropColNamePairs is null");
            return;
        }
        ...
        for (var i = 0; i < reader.FieldCount; i++)
        {
            ...
            else
            {
                ...
                if (!pc.PropColTypesMatched)
                {
                    ...
                    logger.LogInformation(mesg);
                }
                //MappedPropCols.Add(pc);
            }
        }
        logger.LogInformation("unmapped columns: " + String.Join(", ", UnMappedColumnNames));
        logger.LogInformation("unmapped props: " + String.Join(", ", UnMappedPropNames));
    }
    ////===================================================================================================
