...
public abstract class MLogger
{
    ...
    //public RequestData reqData = new RequestData();

    public void Clear()
    {
        EntryQueue = new CircularQueue<LogEntry>(200);
        LogEntryIdCounter = 0;
    }

    //LogEntry zznewLogEntry(MyLogLevel logLevel)
    //{
    //    var ret = new LogEntry { LoggerId = LoggerId, LogLevel = logLevel };
    //    return ret;
    //}
    ...
    public void LogError(Exception? exception, string? message = null, params object?[] args)
    {
        ...
        //if (!IsAppLogger)
        //{
        //    //MyAppContext.Logger.Log(MyLogLevel.Error, exception, message, args);
        //}
    }
    ...
    public void LogWarning(Exception? exception, string? message, params object?[] args)
    {
        ...
        //if (!IsAppLogger)
        //{
        //    //MyAppContext.Logger.Log(MyLogLevel.Warning, exception, message, args);
        //}
    }
    ...
    public string ToHtml(ToHtmlOptions? options = null)
    {
        ...
        return HtmlValue.OfList(EntryQueue, options);
    }
}
//===================================================================================================
