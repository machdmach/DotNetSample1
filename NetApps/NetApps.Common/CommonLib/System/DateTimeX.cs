...
namespace System
{
    public static class DateTimeX
    {
        ...
        */
        ...
        {
            //LogX.Debug(DateTime.Now.ToString("dd-MMM-yyyy"));
            ...
            nvs.Add("DateTime.Ticks", DateTime.Now.Ticks); //
            nvs.Add("DateTime.Ticks", DateTime.Now.Ticks); //

            nvs.Add("ToString()", dt.ToString()); // 7/30/2007 6:34:47 PM
            nvs.Add("ToLongDateString()", dt.ToLongDateString()); // Saturday, June 29, 2007    
            nvs.Add("ToShortDateString()", dt.ToShortDateString()); // 6/29/2007    
            nvs.Add("ToLongTimeString()", dt.ToLongTimeString()); // 6:34:47 PM
            nvs.Add("ToShortTimeString()", dt.ToShortTimeString()); // 6:34 PM
            nvs.Add("-", "");

            String s;
            nvs.Add("Parse('" + (s = "7/30/2007 6:34:47 PM") + "')", DateTime.Parse(s).ToString()); // 7/30/2007 6:34:47 PM
                                                                                                    //nvs.Add("Parse('" + (s = "Saturday, June 29, 2007") + "')", DateTime.Parse(s).ToString()); // 7/30/2007 6:34:47 PM
                                                                                                    //Err, not match day and date.
            nvs.Add("Parse('" + (s = "Saturday, June 09, 2007") + "')", DateTime.Parse(s)); // 7/30/2007 6:34:47 PM
            nvs.Add("Parse('" + (s = "6/29/2007") + "')", DateTime.Parse(s)); // 7/30/2007 6:34:47 PM
            nvs.Add("Parse('" + (s = "6:34:47 PM") + "')", DateTime.Parse(s)); // 7/30/2007 6:34:47 PM
            nvs.Add("Parse('" + (s = "6:34 PM") + "')", DateTime.Parse(s)); // 7/30/2007 6:34:47 PM
                                                                            //           DateTime.Parse(




            nvs.Add("IsDaylightSavingTime()", dt.IsDaylightSavingTime()); // 6:34 PM
            TimeSpan tod = dt.TimeOfDay;
            //DateTime.ParseExact(


            //LogX.Debug(nvs.ToStringX());
            //LogX.Debug("Done " + MethodBase.GetCurrentMethod().DeclaringType);
        }
        ...
        //===================================================================================================
        public static void TryParseTime_Tests()
        {
            TryParseTime_Test("1");
            TryParseTime_Test("1 AM");
            TryParseTime_Test("1 PM");
            TryParseTime_Test("1:1");
            TryParseTime_Test("1:59");
            TryParseTime_Test("18"); //hh
            TryParseTime_Test("231"); //hmm


            TryParseTime_Test("23 PM");
            TryParseTime_Test("23 AM");

            TryParseTime_Test("90");
            TryParseTime_Test("-1");
            TryParseTime_Test("abc");
            TryParseTime_Test("24:00");
            TryParseTime_Test(null);
            TryParseTime_Test("");
            TryParseTime_Test("25:20");
            TryParseTime_Test("1:60");

        }
        public static void TryParseTime_Test(string time)
        {

            bool ok = TryParseTime(time, out TimeSpan ts, out string reason);
            if (ok)
            {
